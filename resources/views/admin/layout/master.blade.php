                    ...
                    <ul class="list-unstyled navbar__list">
                        ...
                        <li>
                            <a href="{{ route('admin#orderList') }}">
                                <i class="fa-solid fa-receipt"></i>Order Lists</a>
                        </li>

                        <li>
                            <a href="{{ route('admin#userList') }}">
                                <i class="fa-solid fa-user"></i>Users Lists</a>
                        </li>

                        <li>
                            <a href="{{ route('admin#userMessageList') }}">
                                <i class="fa-solid fa-message"></i>Message Lists</a>
                        </li>
                    </ul>
                </nav>
            </div>
