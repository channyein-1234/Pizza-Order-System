        ...
        <div class="section__content section__content--p30">
            <div class="container-fluid">
                <div class="col-md-12">
                    ...
                    <div class="row  my-2 col-3 offset-9 ">
                        <h4 class=" text-black text-center">Total results: ({{ $categories->total() }})</h4>
                    </div>
                    ...
                    @else
                        <h3 class="text-secondary text-center">There is no category.</h3>
                    @endif
                    <!-- END DATA TABLE -->
                </div>
            </div>
