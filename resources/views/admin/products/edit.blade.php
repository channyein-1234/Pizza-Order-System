                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-7 ">
                                    <h4 class="my-3 text-white d-block text-capitalize w-50 text-center bg-danger m-2 p-2">
                                        <i class="fa-solid fa-file-signature me-2  "></i>{{ $pizza->name }}
                                    </h4>
                                    <span class="my-3 btn btn-dark text-white"><i
                                            class="fa-solid fa-money-check-dollar me-2  "></i>{{ $pizza->price }}$
                                    </span>
                                    <span class="my-3 btn btn-dark text-white"><i
                                            class="fa-solid fa-eye me-2"></i>{{ $pizza->view_count }}</span>
                                    <span class="my-3 btn btn-dark text-white"><i class="fa-solid fa-pizza-slice"></i>
                                        {{ $pizza->category_name }} </span>
                                    <span class="my-3 btn btn-dark text-white "><i
                                            class="fa-solid fa-user-clock me-2  "></i>{{ $pizza->created_at->format('j-F-Y') }}
                                    </span>
                                    <div class="my-3">Pizza Details<i class="fa-solid fa-circle-info ms-2"></i>
                                    </div>
                                    <div>
                                        {{ $pizza->description }}
                                    </div>
