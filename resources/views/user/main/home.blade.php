                ...
                <div class="bg-light p-4 mb-30">
                    <form>
                        <div class="  d-flex align-items-center justify-content-between mb-3 bg-dark text-white px-3 py-1">
                            ...
                            <span class="badge border text-bg-secondary ">{{ count($category) }}</span>
                        </div>
                ...
                <div class="row pb-3">
                        ...
                        <div class="d-flex align-items-center justify-content-between mb-4">
                            <div>
                                ...
                                <a href="{{ route('user#history') }}">
                                    <button type="button" class="btn btn-dark text-white position-relative">History
                    ...
                    <span id="dataList" class="row">
                        @if (count($pizza) != 0)
                            ...
                            @endforeach
                        @else
                            <p class="text-center  test-white fs-5 col-6 offset-3 py-5"><i
                                    class="fa-solid fa-pizza-slice me-2"></i>There is no product.</p>
                        @endif
                                ...
                                <div class="product-item bg-light mb-4" id="myForm">
                                    ...
                                    <div class="text-center py-4">
                                        ...
                                        <div class="d-flex align-items-center justify-content-center mt-2">
                                            ...
                                            <h6 class="text-muted ml-2"><del>25</del></h6>
                                        </div>
